package com.app.nfc_scanner.NFC
...
class NfcReaderUtils {

    private var onNfcScanListener: OnNfcScanListener? = null

    fun resolveIntent(intent: Intent) {
        Log.wtf("nfc_resolver", "in_resolve_intent")
    ...
    private fun displayMsgs(msgs: Array<NdefMessage?>?) {
        ...
        onNfcScanListener?.nfcBarcode(records[0].str())
    }
    ...
    fun setOnNfcScanListener(onNfcScanListener: OnNfcScanListener?) {
        this.onNfcScanListener = onNfcScanListener
    }

    interface OnNfcScanListener {
        fun nfcBarcode(nfcCode: String)
    }
